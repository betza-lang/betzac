...
-}
module Betzac.Compilation.Driver (SourceReader, SourceCompiler, SourceAccess (..), discover, discoverWith, resolveScopes, resolveScopesFrom, resolvePrelude, sealPrelude) where
...
import Betzac.Compilation.Driver.Resolve (resolveScopes, resolveScopesFrom)
